...
| # | タイトル | 日本語 | English |
|---|---------|--------|---------|
| 1 | ベアリポジトリを自分で作って push | [JP](docs/jp/01_server_bare_repo_create_jp.md) | [EN](docs/en/01_server_bare_repo_create_en.md) |
| 2 | ベアリポジトリからのクローンと push | [JP](docs/jp/02_server_git_workflow_jp.md) | [EN](docs/en/02_server_git_workflow_en.md) |
