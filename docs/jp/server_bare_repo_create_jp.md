...
**ベアリポジトリの場所は `/home/repository/<username>/` 以下に作る。**
...
プロンプトが `<username>@vaccine-00:/home/repository/<username>$` になっていればOK。
...
# 例：git remote add origin /home/repository/yamamoto/example.git
```
